workspace {
    model {
        ...
        internalUser -> bookstoreSystem "Has all functions of Authorized User and can manage the system"
        internalUser -> authSystem "Manage Bookstore System users and their roles"
